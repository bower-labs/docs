...
| **Literature and citation lookups in Bower** (OpenAlex, Crossref, Semantic Scholar, arXiv, Europe PMC, Unpaywall, ORCID) | Unavailable. Searching them would send your query to a public scholarly API. |
...
| **AI quality monitoring** | Available. Request and response text is retained, at a provider covered by our signed BAA and named on the [sub-processor list](/trust-center/sub-processors). **This changed in September 2026**; previously nothing was sent from a Restricted-mode workspace. |
