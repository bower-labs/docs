...
When Bower processes your data (voice transcription, photo text extraction, or Bower conversations), the content is sent to AI model providers for inference.
