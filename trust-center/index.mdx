...
All primary data is hosted on **Google Cloud Platform (us-central1)**. The full list below records each sub-processor's agreement status; where a DPA or BAA is not in place, Restricted mode blocks user content from that provider.
