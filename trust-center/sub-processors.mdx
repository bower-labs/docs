...
| Service | Purpose | Data processed | Location |
|---------|---------|---------------|----------|
| [PostHog](https://posthog.com/privacy) ([DPA](https://posthog.com/privacy#data-processing-agreement) — separately executed, July 2026) | Product analytics, feature flags (requires [cookie consent](/trust-center/cookies)) | Usage events, feature flag evaluations — no research content | US |
