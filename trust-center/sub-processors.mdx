...
| Service | Purpose | Data processed | Location |
|---------|---------|---------------|----------|
| [Mintlify](https://www.mintlify.com/legal/privacy) | Hosts Bower's public help centre and lets Bird search it when you ask how to use Bower | The help question sent to Bird's documentation search, for non-Restricted workspaces only | Vendor-managed (United States and other countries) |

**Restricted-mode workspaces never send help questions to Mintlify.** Bird blocks the external documentation lookup server-side and instead directs you to browse the public help centre without copying workspace content.

**Agreement status:** Bower does not currently have a signed DPA or BAA with Mintlify. The help centre itself contains public Bower documentation. User-written help questions are sent to Mintlify only from non-Restricted workspaces.
