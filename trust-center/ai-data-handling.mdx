...
Most of Bower's AI runs on **Google Vertex AI**, which is covered by a signed Business Associate Agreement (BAA). The other providers handle narrower tasks and are **never used by workspaces in [Restricted mode](/trust-center/hipaa-compliance)** (see below).
