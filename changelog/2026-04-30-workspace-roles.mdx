---
title: "Workspace roles: Owner, Admin, Member, Guest"
description: "Four workspace roles with a clean separation of duties — billing for Owner, member management for Admin, day-to-day work for Member, read-only for Guest."
