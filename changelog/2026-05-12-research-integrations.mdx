---
title: "Bower now reads across eight open scientific sources"
description: "Bower now searches OpenAlex, Semantic Scholar, Crossref, Unpaywall, arXiv, Europe PMC, ORCID, and the open web — and can walk the citation graph for any seed paper."
sidebarTitle: "Wider, deeper research"
---

**Shipped 2026-05-12 · Bower**

Bower's research reach just got significantly wider — and the way it
searches got significantly smarter.

## What's new

Out of the box, Bower now searches **eight open sources** without any
setup or connection step:

- **The open web** via Google.
- **[OpenAlex](https://openalex.org)** — the ~250M-work open catalog.
...
Bower can now walk the citation graph for a paper you already know is
...
much stronger relevance signal than keyword overlap — Bower now uses it
by default.
...
notice." Bower now reads laterally across eight sources, then ranks by
...
Everything Bower does here is gated by the **Public sources** toggle in
the chat composer. Flip it off for any message and Bower won't reach any
