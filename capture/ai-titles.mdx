...
When you capture a voice note, import a file, or let Bower create content, Bower generates a title automatically so you don't have to stop and name things in the moment.
...
- **Bower creates a note** — Bower names its own notes based on what it was asked to do.
