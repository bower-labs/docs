...
The outbound Connectors let Bower reach out to the tools your lab already uses.
...
## What Bower can do via these clients
...
- [Connectors](/integrations/connectors) — let Bower search the tools your lab
