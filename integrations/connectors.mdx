...
Connecting a tool lets Bower _search_ it in place. Importing is different: it makes a copy of your content **inside Bower**, as notes you can edit, search, link, and organise like anything else you've captured. OneNote is the first connector you can import from.
...
<AccordionGroup>
  ...
  <Accordion title="Working with binary files (XLSX, PDF, images)">
    Bower returns a clickable link to binary files in storage tools. To analyse the contents, upload the file to your Bower workspace and Bower will read it with its built-in spreadsheet, PDF, and OCR tools.
  </Accordion>
</AccordionGroup>
