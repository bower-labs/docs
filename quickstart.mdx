...
Once you have notes in your workspace, open the Bower panel on the right side of the desktop app and ask a question in plain language:
...
Bower searches across everything in your workspace and gives you a synthesised answer with sources.
...
<CardGroup cols={2}>
  ...
  <Card title="Collections" icon="folder" href="/organisation/collections">
    Organize notes by experiment, project, or protocol.
  </Card>
  <Card title="Live agent mode" icon="tower-broadcast" href="/ai-and-search/live-agent-mode">
    Real-time conversation with Bower, with video awareness.
  </Card>
