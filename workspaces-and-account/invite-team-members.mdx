...
Bower has four workspace roles. The first three are **paid seats** that count toward your subscription; the fourth is a **free guest** with a per-tier cap.
...
| **Guest** | Free | Read-only across the workspace — browse and search, but no editing, capture, or organisation actions. Right for external supervisors, stakeholders, or compliance reviewers who need visibility without seat cost. |
