...
Bower has four workspace roles. Three are **paid seats** that count toward your subscription; the fourth is a **free guest**, and guests are unlimited on every plan.
...
Guests never consume a paid seat, and there is no limit on how many a workspace
can have, on any plan. Invite as many read-only collaborators as the work needs.

See [plans and pricing](https://bowerlabs.ai/pricing) for what each plan includes.
