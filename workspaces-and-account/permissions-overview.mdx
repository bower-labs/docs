...
* **Guest** (free) — read-only across the workspace, no seat cost. Capped by plan (Starter 1 / Pro 4 / Team 4 per paid seat). Right for external collaborators and stakeholders who need visibility but don't warrant a paid seat.
