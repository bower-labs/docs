...
* **Guest** (free) — read-only across the workspace, no seat cost. Unlimited on every plan. Right for external collaborators and stakeholders who need visibility but don't warrant a paid seat.
...
* The behavior falls back to the previous Bower model — every entity is readable by the workspace Owner.
