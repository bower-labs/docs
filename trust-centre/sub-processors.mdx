...
Word imports in **Restricted-mode workspaces never reach Tiptap** — Bower converts those files itself, and embedded images are not imported. This is enforced server-side. See [HIPAA compliance](/trust-centre/hipaa-compliance) for the full list of what changes in Restricted mode.
...
| Service | Purpose | Data processed | Location |
|---------|---------|---------------|----------|
| [PostHog](https://posthog.com/privacy) ([DPA](https://posthog.com/privacy#data-processing-agreement) — separately executed, July 2026) | Product analytics, feature flags (requires [cookie consent](/trust-centre/cookies)) | Usage events, feature flag evaluations — no research content | US |
