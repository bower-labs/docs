...
- Voice transcription (Google Cloud Speech-to-Text, covered by GCP BAA). The OpenAI transcription fallback available to non-PHI workspaces is **disabled** here — PHI audio stays on Google only.
