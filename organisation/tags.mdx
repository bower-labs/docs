---
title: "Tags"
description: "Add tags to notes and collections for flexible, cross-cutting organization."
---
...
Tags are also tracked in [audit logs](/trust-center/audit-logs) — you can see when tags were added or removed.
...
- **Combine with search** — tags are indexed, so you can search for tagged notes using Bower or the search bar.
