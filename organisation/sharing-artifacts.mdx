...
Every workspace member can see this note or collection at their workspace role — admins and members can edit, guests can only read. This is the default state for everything you create.
