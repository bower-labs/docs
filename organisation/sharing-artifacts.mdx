...
For the bigger picture of who can do what across a workspace — owners, admins, members, viewers, guests — see the [Workspace permissions overview](/workspaces-and-account/permissions-overview).
...
Every workspace member can see this note or collection at their workspace role — owners, admins, and members can edit, while viewers and guests can only read. This is the default state for everything you create.
