...
Collections are how you group related artifacts in Bower. You can think of them like folders on your drive — use them to organize by sample batch, experiment, protocol run, date range, or whatever structure matches how you work.
...
Collections can be nested inside other collections. Drag a collection over another to nest it — useful for organizing by project at the top level and sample batch within.
