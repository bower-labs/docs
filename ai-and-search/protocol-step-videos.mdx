...
description: "Attach a reference video to a protocol and mark where each step happens — then ask Bower to play the right moment, hands-free."
---
...
Markers save automatically as you set them — there's nothing to submit. To change one, clear it (×) and set it again. The step list comes from your protocol's numbered steps; if you haven't run the protocol with Bower yet, the steps come from the document outline and are refined after the first run.

## Asking Bower for the video
...
If a step doesn't have a marker yet, Bower will say so and list the steps that do.
