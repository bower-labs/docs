...
Workspace instructions are **edited only by workspace owners and admins**. Members, viewers, and guests see them in read-only mode so they understand what's shaping Bird's behaviour, but can't change them.
