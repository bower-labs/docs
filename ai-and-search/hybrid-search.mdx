...
- **It's more than search** — the same **Cmd+K** [command palette](/ai-and-search/command-palette) also jumps you to any page or setting, and hands a question to Bird when you press **Tab**.
