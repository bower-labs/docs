...
- **Search from Bower** — for questions that need synthesis rather than retrieval, asking Bower directly is often more useful than a keyword search.
- **It's more than search** — the same **Cmd+K** [command palette](/ai-and-search/command-palette) also jumps you to any page or setting, and hands a question to Bower when you press **Tab**.
