...
description: "Ask Bower for a publication-grade figure or a mermaid diagram and get it back in the conversation as something you can use."
---

Bower can draw two different things in a conversation: **figures**, which are
...
They are different tools for different jobs, and Bower picks based on what you
ask for.
...
<Tip>
  Point Bower at the note or attachment holding the numbers before you ask, using
...
say which you wanted; Bower takes the correction.

## Limits worth knowing

Bower draws what your data says. It will not invent points to fill a gap, and a
...
is deliberately out of scope. Bower refuses those rather than producing something
...
- [Bower](/ai-and-search/bower-ai-assistant), including how to attach a file to a
  conversation
